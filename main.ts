...
let striped : string = personName.trim();
console.log(striped);
...
let guest_names : string []  = ["dua","ujala","neha","ashna","maryam","maham","amna"];
...
let guest_name: string [] = ["dua","ujala","neha","ashna","maryam","maham","amna"];
...
let transpotation : string [] = ["bike","car","bus","motorcycle","aeroplane"];
...
let guesTArr :string[] = [`UJALA`,`DUA`,`NEHA`,`ASHNA`,`SAAD`,`HASAN`]
...
guestArr.map((items) =>
console.log(`DEAR ${items}, I found a bigger dinner table so i invited mmore people.`)
);


// part 2 began 
let guestbeg : string = "AMNA"
...
let guests: string [] = [ `ALI`,`BILAL`,`HARRY`, `DAWOOD`,`SAAD`,`HASAN`];
...
let  placetovisit: string [] = ["UK" , "TURKEY" , "KOREA" , "PARIS" , "AMERICA."];
...
let country : string [] = [`UK`,`SOUTH KOREA`,`AMEICA`,`TURKEY`,`PARIS`]
console.log (`list of country`);
console.log(country);

let person: {name :string , fname: string, age: number} ={name : "Ayesha" , fname: "female" , age : 17}
console.log (person);
...
let name_2 :string = "ayesha amjad"
let name_3 :string = "ayesha amjad fazal"
...
console.log ("younger")
 ...
 let countries : string []= ["UK" , "TURKEY" , "KOREA"  , "AMERICA."]; 
...
let aliens_colors: string= "yellow "
...
let users : string [] = ["admin","eric","ibrahim","irha"]
...
let user : string [] = ["admin","eric","ibrahim","irha"]
if (user.length ===0) {
...
function displayMessages(users: string[]): void {
...
let current_users : string[] = ["Ayesha", "Hasan", "Saad", "Neha","Admin"]
let new_users = ["Ashna", " Maryam","Amna" , "Ayesha" , "Admin"]
 
let current_users_lowercase :string [] = current_users.map(user => user.toLocaleLowerCase())
...
// 39
function discribe_city(city: string, country: string = `PAKISTAN`): void {
console.log (`${city}is in ${country}`)
}
...
const magicians: string[] = ["usman", "haseeb", "wajahat"];
...
const magicians2: string[] = ["MAHIR", "SHAHMEER", "UMAR"];
...
function make_great2 (magicians: string []) :string[] {
 ...
 const magicians3: string[] = ['MAHIR', 'SHAHMEER', 'UMAR'];
...
const myCar: Car = createCar("Toyota", "honda", ["color", "red"], ["year", 2022]);
